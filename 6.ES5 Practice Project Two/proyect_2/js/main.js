...
function getLooser(){
    ...
    this.showList = function(){
        ...
        for(var i=1;i< this.applicants.length;i++){
    ...
    this.showRandomUser = function(){
        ...
        var randomUser = this.applicants[Math.floor(Math.random()*Math.length)];

        resultsContainer.innerHTML ='';
        resultsContainer.insertAdjacentHTML('afterbegin','<h3>'+randomUser+'</h3>')
    }
